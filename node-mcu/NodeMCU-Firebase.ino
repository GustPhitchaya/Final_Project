...
#include <NTPClient.h>
#include <WiFiUdp.h>
// ต้นฉบับ https://randomnerdtutorials.com/esp8266-data-logging-firebase-realtime-database/#ESP-Datalogging-RTDB
// ต้นฉบับ https://randomnerdtutorials.com/esp8266-nodemcu-firebase-realtime-database/
